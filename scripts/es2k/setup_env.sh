...
export P4CP_DEP_INSTALL=$3
export P4CP_INSTALL=$4

# Get the OS and Version details
# shellcheck source=/dev/null
. "$P4CP_SOURCE/scripts/es2k/os_ver_details.sh"
get_os_ver_details
...
export LD_LIBRARY_PATH=$P4CP_DEP_INSTALL/lib:$P4CP_DEP_INSTALL/lib64:$LD_LIBRARY_PATH
export PATH=$P4CP_DEP_INSTALL/bin:$P4CP_DEP_INSTALL/sbin:$P4CP_INSTALL/sbin:$P4CP_INSTALL/bin:$PATH
export LIBRARY_PATH=$P4CP_DEP_INSTALL/lib:$P4CP_DEP_INSTALL/lib64:$LIBRARY_PATH
...
sudo bash "$P4CP_INSTALL/bin/es2k/scripts/copy_config_files.sh"
sudo bash "$P4CP_INSTALL/bin/es2k/scripts/set_hugepages.sh"
set +e
