...
class GeneveEncapV4VlanPopTest : public IpTunnelTest {
 protected:
  GeneveEncapV4VlanPopTest() {}

  void SetUp() { SelectTable("geneve_encap_vlan_pop_mod_table"); }

  void InitAction() { SelectAction("geneve_encap_vlan_pop"); }
