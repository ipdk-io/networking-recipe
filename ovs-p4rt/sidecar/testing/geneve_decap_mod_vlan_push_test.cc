...
class GeneveDecapModVlanPushTest : public BaseTableTest {
 protected:
  GeneveDecapModVlanPushTest() {}

  void SetUp() { SelectTable("geneve_decap_and_push_vlan_mod_table"); }

  void InitAction() { SelectAction("geneve_decap_and_push_vlan"); }
...
TEST_F(GeneveDecapModVlanPushTest, remove_entry) {
  // Arrange
  InitTunnelInfo();
...
TEST_F(GeneveDecapModVlanPushTest, insert_entry) {
  // Arrange
  InitTunnelInfo();
  InitAction();
...
TEST_F(GeneveDecapModVlanPushTest, insert_entry_with_24_bit_vni) {
  // Arrange
  InitTunnelInfo();
