...
#ifndef P4RT_PERF_SESSION_H_
#define P4RT_PERF_SESSION_H_
...
class P4rtSession {
 public:
  ...
  static ::absl::StatusOr<std::unique_ptr<P4rtSession>> Create(
  ...
  P4rtSession(const P4rtSession&) = delete;
  P4rtSession& operator=(const P4rtSession&) = delete;

  // Allow move semantics.
  P4rtSession(P4rtSession&&) = default;
  P4rtSession& operator=(P4rtSession&&) = default;
...
// Functions that operate on a P4rtSession.
