...
PCI_BDF can be obtained using the lspci command.
...
For any tx control packet from VM1 (TDP 0), pipeline should add a VLAN tag 1
...
- Once Peer is also configured, we should see neighbors 50.1.1.2 and 60.1.1.2
