...
Counter<ByteCounter_t, PortId_t>(NUM_PORTS, PSA_CounterType_t.BYTES) ipv4_host_tbl_flow_counter_bytes;
Counter<PacketCounter_t, PortId_t>(NUM_PORTS, PSA_CounterType_t.PACKETS) ipv4_host_tbl_flow_counter_packets;
...
)
{
    ...
    apply {
                ipv4_host_tbl_flow_counter_bytes.count(ig_intr_md.ingress_port, 64);
                ipv4_host_tbl_flow_counter_packets.count(ig_intr_md.ingress_port, 1);
                ipv4_host.apply();
    }
}
